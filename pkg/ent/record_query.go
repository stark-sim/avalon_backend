...
func (rq *RecordQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Record, error) {
	...
	if query := rq.withRoom; query != nil {
		if err := rq.loadRoom(ctx, query, nodes, nil,
			func(n *Record, e *Room) { n.Edges.Room = e }); err != nil {
			return nil, err
		}
	}
...
func (rq *RecordQuery) loadRoom(ctx context.Context, query *RoomQuery, nodes []*Record, init func(*Record), assign func(*Record, *Room)) error {
