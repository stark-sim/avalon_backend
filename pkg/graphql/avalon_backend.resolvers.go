...
// AssassinChance is the resolver for the assassinChance field.
func (r *gameResolver) AssassinChance(ctx context.Context, obj *ent.Game) (int, error) {
	return int(obj.AssassinChance), nil
}
...
// AssassinChance is the resolver for the assassinChance field.
func (r *createGameInputResolver) AssassinChance(ctx context.Context, obj *ent.CreateGameInput, data *int) error {
	if data != nil {
		tempData := uint8(*data)
		obj.AssassinChance = &tempData
	} else {
		obj.AssassinChance = nil
	}
	return nil
}
...
// AssassinChance is the resolver for the assassinChance field.
func (r *gameWhereInputResolver) AssassinChance(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChance - assassinChance"))
}

// AssassinChanceNeq is the resolver for the assassinChanceNEQ field.
func (r *gameWhereInputResolver) AssassinChanceNeq(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceNeq - assassinChanceNEQ"))
}

// AssassinChanceIn is the resolver for the assassinChanceIn field.
func (r *gameWhereInputResolver) AssassinChanceIn(ctx context.Context, obj *ent.GameWhereInput, data []int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceIn - assassinChanceIn"))
}

// AssassinChanceNotIn is the resolver for the assassinChanceNotIn field.
func (r *gameWhereInputResolver) AssassinChanceNotIn(ctx context.Context, obj *ent.GameWhereInput, data []int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceNotIn - assassinChanceNotIn"))
}

// AssassinChanceGt is the resolver for the assassinChanceGT field.
func (r *gameWhereInputResolver) AssassinChanceGt(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceGt - assassinChanceGT"))
}

// AssassinChanceGte is the resolver for the assassinChanceGTE field.
func (r *gameWhereInputResolver) AssassinChanceGte(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceGte - assassinChanceGTE"))
}

// AssassinChanceLt is the resolver for the assassinChanceLT field.
func (r *gameWhereInputResolver) AssassinChanceLt(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceLt - assassinChanceLT"))
}

// AssassinChanceLte is the resolver for the assassinChanceLTE field.
func (r *gameWhereInputResolver) AssassinChanceLte(ctx context.Context, obj *ent.GameWhereInput, data *int) error {
	panic(fmt.Errorf("not implemented: AssassinChanceLte - assassinChanceLTE"))
}
...
// AssassinChance is the resolver for the assassinChance field.
func (r *updateGameInputResolver) AssassinChance(ctx context.Context, obj *ent.UpdateGameInput, data *int) error {
	if data != nil {
		tempData := uint8(*data)
		obj.AssassinChance = &tempData
	} else {
